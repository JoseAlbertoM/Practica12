...
return $periodoSatelite;
       ...
       //  $d.innerHTML= 'El periodo del satélite que vuela a 10,000 km del centro de la Tierra es aproximadamente  ' + $periodoSatelite.toFixed(2) + '  Dias';
         }
/*
         $distanciaTierraLuna = 3.8e5; // Distancia de la Tierra a la Luna en km
         $altitudSatelite = 1e4; // Altitud del satélite en km
         $semiejeMayor = 6.371e3 + $distanciaTierraLuna + $altitudSatelite;
         $periodoSatelite = sqrt(pow(27.3, 2) * pow($semiejeMayor, 3) / pow($distanciaTierraLuna, 3));
         $resultado = 'El periodo del satélite que vuela a 10,000 km del centro de la Tierra es aproximadamente ' . number_format($periodoSatelite, 2) . ' días';
         
         <!-- Dentro del documento HTML -->
         <div id="resultadoA"><?php echo $resultado; ?></div>
         */
